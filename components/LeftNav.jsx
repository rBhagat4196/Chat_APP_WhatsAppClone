...
const uploadImageToFirebase = async (file) => {
  ...
  return (
    <div className={` ${editProfile ?  "w-[350px]" : "w-[80px]"} h-[100vh] items-center flex flex-col justify-between py-5 shrink-0 transition-all `}>
      {editProfile ? (
                ...
                <>
                    {currentUser && (
                        ...
                        >
                            ...
                            <div className="w-full h-full rounded-full bg-black/[0.5] absolute top-0 left-0 justify-center items-center hidden group-hover:flex">
                                <BiEdit size={14}  onClick={()=>{setEditProfile(true)}}/>
                            </div>
                        </div>
                    )}
                </>
